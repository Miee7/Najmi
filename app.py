...
def main():
    ...
    joiningyear = st.slider('JoiningYYear:', 2012, 2018, 2015)
    ...
    if user_input_form.form_submit_button('Predict'):
        ...
        expected_columns = ['education', 'joiningyear', 'city_Bangalore', 'city_Pune', 'city_New Delhi', 'paymenttier', 'age', 'gender', 'everbenched', 'experienceincurrentdomain']
